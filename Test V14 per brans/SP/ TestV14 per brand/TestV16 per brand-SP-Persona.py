...
try:
    ...
    st.warning("⚠️ python-pptx not installed. PowerPoint download unavailable.")
...
"""
    ...
    if ai_output:
        ...
        if PPTX_AVAILABLE:
            ...
            slide.shapes.add_textbox(Inches(0.5), Inches(0.5), Inches(9), Inches(1)).text_frame.text = "AI Sales Call Response"
            slide.shapes.add_textbox(Inches(0.5), Inches(1.5), Inches(9), Inches(4)).text_frame.text = ai_output
            ppt_buffer = io_bytes()
            prs.save(ppt_buffer)
