...
with col1:
    try:
        ...
        st.image(logo_fallback_url, width=200)
with col2:
...
race_segments = [
    ...
    "C – Conversion: Proactively initiate discussion with specific patient profile For other patient profiles but he is not prescribing yet.",
